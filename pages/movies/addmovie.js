...
console.log(genreMovies)
  ...
  const checkMovieData = {
    img, imgTitle, title, description, year, duration, trailer, video, pixels, selectedGenres,
  }
  useEffect(() => {
    const isMovie = Object.values({ img, imgTitle, title, description, year, duration, trailer, video, pixels, selectedGenres }).every(item => Boolean(item));
